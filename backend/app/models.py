...
class Candidate(Base):
    ...
    # How many retry-incomplete Full attempts have failed for this stub.
    # At MAX_ENRICH_RETRY_ATTEMPTS the row is skipped by auto-retry (manual only).
    enrich_retry_count: Mapped[int] = mapped_column(
